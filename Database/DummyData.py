...
def insertDummyData(repoInstance: Repository):
    ...
    #       Into Accounts
    repoInstance.execute("""INSERT INTO accounts(account_name,account_holder_dob,account_holder_address,balance,account_open_date,account_details,account_type,account_holder_phone_no) 
...
("Vivek Maheshwari","2000.05.03","vesu",987902.22,"2019.02.01","",2,1893023412);""")
    ...
    repoInstance.execute("""INSERT INTO accounts(account_name,account_holder_dob,account_holder_address,balance,account_open_date,
...
VALUES("Vishesh Jain","1978.07.11","Bhatar surat",920238.2,"1988.04.02","",3,7839212352);""")
    ...
    repoInstance.execute("""INSERT INTO transactions(date_of_transaction,amount_of_transaction,from_account,to_account,transaction_type_code)
...
(CURDATE(),12322,4,3,2);""")
    ...
    # Dummy Data of users
    repoInstance.execute("""INSERT INTO `USERS` VALUES("@WILLIAMJONES","ABCDEFGHI",1);""")
