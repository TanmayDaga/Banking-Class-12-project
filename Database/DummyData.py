...
def insertDummyData(qm: QueryManager):
    ...
    #       Into Accounts
    qm.execute("""INSERT INTO accounts(account_name,account_holder_dob,account_holder_address,balance,account_open_date,account_details,account_type) 
VALUES("William Jones","1987.06.07","Brown Street,London",78930.23,"1999.08.07","",1),
("Charles Green","1988.07.09","Green Avene, NYC",9473.24,"2000.07.06","",2),
("Tanmay Daga","1986.05.04","Parvat Patia, Surat",28340.3,"2004.03.02","",1),
("Vivek Maheshwari","2000.05.03","vesu",987902.22,"2019.02.01","",2);""")
...
VALUES("Vishesh Jain","1978.07.11","Bhatar surat",920238.2,"1988.04.02","",3);""")
